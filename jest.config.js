...
const customJestConfig = {
  ...
  testPathIgnorePatterns: [
    ...
    '<rootDir>/__tests__/property/ai-risk-management.property.test.ts',
    '<rootDir>/__tests__/chrome-scroll-system-integration.test.tsx',
    '<rootDir>/__tests__/chrome-scroll-validation.test.ts',
