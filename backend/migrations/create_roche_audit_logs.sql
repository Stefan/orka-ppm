-- Migration: Create Roche Construction PPM Audit Logs Table
-- Requirements: 7.2, 7.6, 8.5, 9.5
-- Description: Comprehensive audit logging for all Roche Construction PPM features
...
COMMENT ON TABLE roche_audit_logs IS 'Comprehensive audit trail for Roche Construction PPM features including shareable URLs, simulations, scenarios, change management, PO breakdowns, and report generation';
