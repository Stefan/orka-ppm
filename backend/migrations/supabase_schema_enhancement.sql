-- AI-Powered PPM Platform - Complete Database Schema Enhancement
...
-- Create basic RLS policies (idempotent - safe to run multiple times)
-- Allow authenticated users to read/write their organization's data

-- Portfolios policies
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_catalog.pg_policies WHERE LOWER(polname) = 'users can view portfolios' AND schemaname = 'public' AND tablename = 'portfolios') THEN
        CREATE POLICY "Users can view portfolios" ON public.portfolios FOR SELECT USING (auth.role() = 'authenticated');
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_catalog.pg_policies WHERE LOWER(polname) = 'users can insert portfolios' AND schemaname = 'public' AND tablename = 'portfolios') THEN
        CREATE POLICY "Users can insert portfolios" ON public.portfolios FOR INSERT WITH CHECK (auth.role() = 'authenticated');
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_catalog.pg_policies WHERE LOWER(polname) = 'users can update portfolios' AND schemaname = 'public' AND tablename = 'portfolios') THEN
        CREATE POLICY "Users can update portfolios" ON public.portfolios FOR UPDATE USING (auth.role() = 'authenticated');
    END IF;
END $$;

-- Risks policies
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_catalog.pg_policies WHERE LOWER(polname) = 'users can view risks' AND schemaname = 'public' AND tablename = 'risks') THEN
        CREATE POLICY "Users can view risks" ON public.risks FOR SELECT USING (auth.role() = 'authenticated');
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_catalog.pg_policies WHERE LOWER(polname) = 'users can insert risks' AND schemaname = 'public' AND tablename = 'risks') THEN
        CREATE POLICY "Users can insert risks" ON public.risks FOR INSERT WITH CHECK (auth.role() = 'authenticated');
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_catalog.pg_policies WHERE LOWER(polname) = 'users can update risks' AND schemaname = 'public' AND tablename = 'risks') THEN
        CREATE POLICY "Users can update risks" ON public.risks FOR UPDATE USING (auth.role() = 'authenticated');
    END IF;
END $$;

-- Issues policies
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_catalog.pg_policies WHERE LOWER(polname) = 'users can view issues' AND schemaname = 'public' AND tablename = 'issues') THEN
        CREATE POLICY "Users can view issues" ON public.issues FOR SELECT USING (auth.role() = 'authenticated');
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_catalog.pg_policies WHERE LOWER(polname) = 'users can insert issues' AND schemaname = 'public' AND tablename = 'issues') THEN
        CREATE POLICY "Users can insert issues" ON public.issues FOR INSERT WITH CHECK (auth.role() = 'authenticated');
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_catalog.pg_policies WHERE LOWER(polname) = 'users can update issues' AND schemaname = 'public' AND tablename = 'issues') THEN
...
-- Workflows policies
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_catalog.pg_policies WHERE LOWER(polname) = 'users can view workflows' AND schemaname = 'public' AND tablename = 'workflows') THEN
        CREATE POLICY "Users can view workflows" ON public.workflows FOR SELECT USING (auth.role() = 'authenticated');
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_catalog.pg_policies WHERE LOWER(polname) = 'users can insert workflows' AND schemaname = 'public' AND tablename = 'workflows') THEN
        CREATE POLICY "Users can insert workflows" ON public.workflows FOR INSERT WITH CHECK (auth.role() = 'authenticated');
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_catalog.pg_policies WHERE LOWER(polname) = 'users can update workflows' AND schemaname = 'public' AND tablename = 'workflows') THEN
        CREATE POLICY "Users can update workflows" ON public.workflows FOR UPDATE USING (auth.role() = 'authenticated');
    END IF;
END $$;

-- Workflow instances policies
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_catalog.pg_policies WHERE LOWER(polname) = 'users can view workflow_instances' AND schemaname = 'public' AND tablename = 'workflow_instances') THEN
        CREATE POLICY "Users can view workflow_instances" ON public.workflow_instances FOR SELECT USING (auth.role() = 'authenticated');
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_catalog.pg_policies WHERE LOWER(polname) = 'users can insert workflow_instances' AND schemaname = 'public' AND tablename = 'workflow_instances') THEN
        CREATE POLICY "Users can insert workflow_instances" ON public.workflow_instances FOR INSERT WITH CHECK (auth.role() = 'authenticated');
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_catalog.pg_policies WHERE LOWER(polname) = 'users can update workflow_instances' AND schemaname = 'public' AND tablename = 'workflow_instances') THEN
        CREATE POLICY "Users can update workflow_instances" ON public.workflow_instances FOR UPDATE USING (auth.role() = 'authenticated');
    END IF;
END $$;

-- Workflow approvals policies
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_catalog.pg_policies WHERE LOWER(polname) = 'users can view workflow_approvals' AND schemaname = 'public' AND tablename = 'workflow_approvals') THEN
        CREATE POLICY "Users can view workflow_approvals" ON public.workflow_approvals FOR SELECT USING (auth.role() = 'authenticated');
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_catalog.pg_policies WHERE LOWER(polname) = 'users can insert workflow_approvals' AND schemaname = 'public' AND tablename = 'workflow_approvals') THEN
        CREATE POLICY "Users can insert workflow_approvals" ON public.workflow_approvals FOR INSERT WITH CHECK (auth.role() = 'authenticated');
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_catalog.pg_policies WHERE LOWER(polname) = 'users can update workflow_approvals' AND schemaname = 'public' AND tablename = 'workflow_approvals') THEN
        CREATE POLICY "Users can update workflow_approvals" ON public.workflow_approvals FOR UPDATE USING (auth.role() = 'authenticated');
    END IF;
END $$;

-- Financial tracking policies
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_catalog.pg_policies WHERE LOWER(polname) = 'users can view financial_tracking' AND schemaname = 'public' AND tablename = 'financial_tracking') THEN
        CREATE POLICY "Users can view financial_tracking" ON public.financial_tracking FOR SELECT USING (auth.role() = 'authenticated');
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_catalog.pg_policies WHERE LOWER(polname) = 'users can insert financial_tracking' AND schemaname = 'public' AND tablename = 'financial_tracking') THEN
        CREATE POLICY "Users can insert financial_tracking" ON public.financial_tracking FOR INSERT WITH CHECK (auth.role() = 'authenticated');
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_catalog.pg_policies WHERE LOWER(polname) = 'users can update financial_tracking' AND schemaname = 'public' AND tablename = 'financial_tracking') THEN
        CREATE POLICY "Users can update financial_tracking" ON public.financial_tracking FOR UPDATE USING (auth.role() = 'authenticated');
    END IF;
END $$;

-- Milestones policies
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_catalog.pg_policies WHERE LOWER(polname) = 'users can view milestones' AND schemaname = 'public' AND tablename = 'milestones') THEN
        CREATE POLICY "Users can view milestones" ON public.milestones FOR SELECT USING (auth.role() = 'authenticated');
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_catalog.pg_policies WHERE LOWER(polname) = 'users can insert milestones' AND schemaname = 'public' AND tablename = 'milestones') THEN
        CREATE POLICY "Users can insert milestones" ON public.milestones FOR INSERT WITH CHECK (auth.role() = 'authenticated');
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_catalog.pg_policies WHERE LOWER(polname) = 'users can update milestones' AND schemaname = 'public' AND tablename = 'milestones') THEN
...
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_catalog.pg_policies WHERE LOWER(polname) = 'users can view project_resources' AND schemaname = 'public' AND tablename = 'project_resources') THEN
        CREATE POLICY "Users can view project_resources" ON public.project_resources FOR SELECT USING (auth.role() = 'authenticated');
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_catalog.pg_policies WHERE LOWER(polname) = 'users can insert project_resources' AND schemaname = 'public' AND tablename = 'project_resources') THEN
        CREATE POLICY "Users can insert project_resources" ON public.project_resources FOR INSERT WITH CHECK (auth.role() = 'authenticated');
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_catalog.pg_policies WHERE LOWER(polname) = 'users can update project_resources' AND schemaname = 'public' AND tablename = 'project_resources') THEN
        CREATE POLICY "Users can update project_resources" ON public.project_resources FOR UPDATE USING (auth.role() = 'authenticated');
    END IF;
END $$;

-- Audit logs policies
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_catalog.pg_policies WHERE LOWER(polname) = 'users can view audit_logs' AND schemaname = 'public' AND tablename = 'audit_logs') THEN
        CREATE POLICY "Users can view audit_logs" ON public.audit_logs FOR SELECT USING (auth.role() = 'authenticated');
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_catalog.pg_policies WHERE LOWER(polname) = 'users can insert audit_logs' AND schemaname = 'public' AND tablename = 'audit_logs') THEN
        CREATE POLICY "Users can insert audit_logs" ON public.audit_logs FOR INSERT WITH CHECK (auth.role() = 'authenticated');
    END IF;
END $$;