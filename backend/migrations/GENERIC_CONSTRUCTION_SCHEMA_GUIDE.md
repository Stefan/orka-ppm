# Generic Construction PPM Features - Database Schema Guide

## Overview

This guide documents the database schema for the six specialized Construction/Engineering PPM features implemented for Generic:
