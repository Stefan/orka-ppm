#!/usr/bin/env python3
"""
Apply Generic Construction/Engineering PPM Features Migration
...
def read_migration_file() -> str:
    ...
    migration_path = os.path.join(os.path.dirname(__file__), "migrations", "011_generic_construction_ppm_features.sql")
...
def apply_migration(supabase: Client, sql_content: str) -> bool:
    ...
    try:
        print("🚀 Starting Generic Construction/Engineering PPM Features migration...")
...
def main():
    ...
    try:
        print("🏗️  Generic Construction/Engineering PPM Features Migration")
        print("=" * 60)
        ...
        print("\nPlease:")
        print("1. Copy the contents of migrations/011_generic_construction_ppm_features.sql")
