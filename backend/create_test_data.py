#!/usr/bin/env python3
"""
Create test data for the PPM platform
"""
import os
import sys
...
def create_test_data():
    """Create comprehensive test data for the PPM platform"""
    
    print("🚀 Creating test data for PPM platform...")
    ...
    try:
        ...
        # 3. Create test projects with different statuses and health
        ...
        # 4. Create milestones for projects
        ...
        milestones_data.extend([
            ...
            },
            {
                ...
                "description": "Implement new microservices",
                "due_date": "2024-07-31",
                "status": "in_progress",
        ...
        risks_data = [
            ...
            },
            {
                ...
                "impact": 0.9,
                "status": "analyzing",
                "mitigation": "Scope reduction and timeline extension under review",
                "owner_id": resource_ids[1],
                "due_date": "2024-05-01"
            }
        ]
        ...
        # 6. Create financial tracking records
        print("\n💰 Creating financial tracking records...")
        financial_data = []
        
        # Financial records for Customer Portal Redesign
        financial_data.extend([
            {
                ...
                "actual_amount": 180000.0,
                "currency": "USD",
                "date_incurred": "2024-05-31"
            },
            {
                "project_id": project_ids[0],
                "category": "Design",
                "description": "UI/UX design and research",
                "planned_amount": 80000.0,
                "actual_amount": 75000.0,
                "currency": "USD",
                "date_incurred": "2024-04-30"
            },
            {
                "project_id": project_ids[0],
                ...
                "currency": "USD",
                "date_incurred": "2024-06-30"
            }
        ])
        
        supabase.table("financial_tracking").insert(financial_data).execute()
        print(f"✅ Created {len(financial_data)} financial records")
        ...
        print(f"   • {len(financial_data)} Financial records created")
