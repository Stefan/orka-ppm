...
describe('currency-utils', () => {
  describe('getAllCurrencies', () => {
    it('returns all Currency enum values', () => {
      ...
      expect(list).toContain(Currency.PLN)
      expect(list).toContain(Currency.MXN)
      expect(list).toContain(Currency.CNY)
      expect(list).toContain(Currency.INR)
      expect(list).toContain(Currency.KRW)
      expect(list).toContain(Currency.VND)
