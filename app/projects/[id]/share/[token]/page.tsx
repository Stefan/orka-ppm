...
export default function GuestProjectAccessPage() {
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center p-4">
        <Card className="max-w-md w-full">
          <CardContent className="py-12 text-center">
            {/* Error Icon */}
            {error.type === 'expired' && (
              <Clock className="h-16 w-16 text-yellow-500 dark:text-yellow-400 mx-auto mb-4" />
            )}
            {error.type === 'revoked' && (
            ...
            {error.type === 'server_error' && (
              <AlertCircle className="h-16 w-16 text-gray-500 dark:text-slate-400 mx-auto mb-4" />
            )}
            ...
            {error.type === 'server_error' && (
              <div className="bg-gray-50 dark:bg-slate-800/50 border border-gray-200 dark:border-slate-700 rounded-lg p-4 mb-6 text-left">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center p-4">
      <Card className="max-w-md w-full">
        <CardContent className="py-12 text-center">
          <AlertCircle className="h-16 w-16 text-gray-400 dark:text-slate-500 mx-auto mb-4" />
          <h2 className="text-xl font-semibold text-gray-900 dark:text-slate-100 mb-2">
