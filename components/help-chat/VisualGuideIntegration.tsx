...
export function VisualGuideIntegration({
  ...
  return (
    <div className={cn(
      ...
      <div className={cn(
        'bg-white dark:bg-slate-800 rounded-lg shadow-xl w-full max-w-6xl h-full max-h-[90vh] flex flex-col',
          ...
          <div className="flex items-center space-x-2">
            {currentView === 'player' && (
              <button
                ...
                className="px-3 py-2 text-gray-600 hover:text-gray-900 dark:hover:text-slate-100 dark:text-slate-100 hover:bg-gray-100 dark:hover:bg-slate-600 dark:bg-slate-700 rounded-md transition-colors text-sm"
              >
                ← Back to Guides
              </button>
            )}
            ...
            {currentView === 'manager' ? (
              <div className="h-full flex flex-col">
                ...
                {recommendations.length > 0 && (
                  <div className="border-b border-gray-200 dark:border-slate-700 bg-blue-50 dark:bg-blue-900/20 p-4">
...
function RecommendationCard({ recommendation, onSelect }: RecommendationCardProps) {
  ...
  return (
    <div className="bg-white dark:bg-slate-800 border border-blue-300 dark:border-blue-800 rounded-lg p-3 hover:shadow-md transition-shadow cursor-pointer"
         onClick={onSelect}>
      <div className="flex items-start space-x-3">
        {/* Thumbnail */}
        <div className="flex-shrink-0 w-12 h-12 bg-gray-100 dark:bg-slate-700 rounded-md flex items-center justify-center overflow-hidden">
