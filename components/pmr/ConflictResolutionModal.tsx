    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black bg-opacity-50">
      <div className="bg-white dark:bg-slate-800 rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          {/* Original Content */}
          <div>
            <h3 className="text-sm font-medium text-gray-900 dark:text-slate-100 mb-2">Original Content</h3>
          ...
          {/* Conflicting Changes */}
          <div>
            <h3 className="text-sm font-medium text-gray-900 dark:text-slate-100 mb-3">Conflicting Changes</h3>
          ...
          {/* Resolution Strategy */}
          <div>
            <h3 className="text-sm font-medium text-gray-900 dark:text-slate-100 mb-3">Resolution Strategy</h3>
            <div className="space-y-2">
              <label className="flex items-start space-x-3 p-3 border border-gray-200 dark:border-slate-700 rounded-lg cursor-pointer hover:bg-gray-50 dark:hover:bg-slate-700 dark:bg-slate-800/50">
                <input
                  type="radio"
                  name="resolution"
                  value="overwrite"
                ...
                />
                <div className="flex-1">
                  <p className="text-sm font-medium text-gray-900 dark:text-slate-100">Use Selected Change</p>
              ...
              <label className="flex items-start space-x-3 p-3 border border-gray-200 dark:border-slate-700 rounded-lg cursor-pointer hover:bg-gray-50 dark:hover:bg-slate-700 dark:bg-slate-800/50">
                ...
                />
                <div className="flex-1">
                  <p className="text-sm font-medium text-gray-900 dark:text-slate-100">Merge Changes</p>
                  <p className="text-xs text-gray-600 dark:text-slate-400 mt-1">
              ...
              <label className="flex items-start space-x-3 p-3 border border-gray-200 dark:border-slate-700 rounded-lg cursor-pointer hover:bg-gray-50 dark:hover:bg-slate-700 dark:bg-slate-800/50">
                ...
                />
                <div className="flex-1">
                  <p className="text-sm font-medium text-gray-900 dark:text-slate-100">Manual Resolution</p>
                  <p className="text-xs text-gray-600 dark:text-slate-400 mt-1">
        ...
        {/* Footer */}
        <div className="flex items-center justify-end space-x-3 p-6 border-t border-gray-200 dark:border-slate-700 bg-gray-50 dark:bg-slate-800/50">
          <button
            onClick={onClose}
            className="px-4 py-2 text-sm font-medium text-gray-700 dark:text-slate-300 bg-white dark:bg-slate-800 border border-gray-300 dark:border-slate-600 rounded-lg hover:bg-gray-50 dark:hover:bg-slate-700"
          >
            Cancel
          </button>
          <button
