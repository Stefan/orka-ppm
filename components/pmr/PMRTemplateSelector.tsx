...
const PMRTemplateSelector: React.FC<PMRTemplateSelectorProps> = ({
  ...
  const renderTemplateCard = (template: PMRTemplate) => {
    ...
    return (
      <div
        key={template.id}
        className={`relative bg-white border-2 rounded-lg shadow-sm transition-all cursor-pointer hover:shadow-md ${
        ...
        <div className="p-4">
          ...
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center space-x-2">
              <span className="px-2 py-1 text-xs font-medium text-blue-700 bg-blue-100 rounded-full capitalize">
          ...
          <div className="flex items-center space-x-2 pt-3 border-t border-gray-200">
            ...
            {onCustomizeTemplate && (
              <button
                ...
                className="flex items-center space-x-1 px-2 py-1 text-xs font-medium text-blue-700 bg-blue-100 rounded-md hover:bg-blue-200 transition-colors"
              >
            ...
            {onRateTemplate && (
              <button
                ...
                className="flex items-center space-x-1 px-2 py-1 text-xs font-medium text-yellow-700 bg-yellow-100 rounded-md hover:bg-yellow-200 transition-colors"
              >
        ...
        <div className="p-4 border-b border-gray-200 bg-gray-50 space-y-3">
          ...
          <div className="flex items-center space-x-4">
            <label className="flex items-center space-x-2 cursor-pointer">
              ...
              />
              <span className="text-xs text-gray-700">Public only</span>
            </label>
            <label className="flex items-center space-x-2 cursor-pointer">
              <input
                type="checkbox"
                ...
                className="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
              />
              <span className="text-xs text-gray-700">AI suggested only</span>
            </label>
          </div>
      ...
      {aiSuggestedTemplates.length > 0 && !filters.showAISuggested && (
        <div className="p-4 bg-gradient-to-r from-purple-50 to-blue-50 border-b border-gray-200">
          <div className="flex items-center space-x-2 mb-3">
            ...
            <h4 className="text-sm font-medium text-gray-900">AI Recommended for Your Project</h4>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            {templates
              ...
              .map(template => (
                <div
                  key={template.id}
                  className="p-3 bg-white border border-purple-200 rounded-lg cursor-pointer hover:border-purple-400 transition-colors"
                  onClick={() => handleSelectTemplate(template.id)}
                >
                  ...
                  <div className="flex items-center space-x-2">
                    <Star className="h-3 w-3 text-yellow-500" />
                    <span className="text-xs text-gray-600">{template.rating?.toFixed(1) || 'N/A'}</span>
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full mx-4">
        <div className="p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-semibold text-gray-900">Rate Template</h3>
            <button
              onClick={onClose}
