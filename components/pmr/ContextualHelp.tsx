...
export const ContextualHelp: React.FC<ContextualHelpProps> = ({
  ...
  const tooltip = isOpen && (
    <div
      ref={tooltipRef}
      className={`fixed z-50 w-80 bg-white rounded-lg shadow-xl border border-gray-200 ${tooltipClassName}`}
      style={{
    ...
    >
      ...
      <div className="p-4 space-y-3 max-h-96 overflow-y-auto">
        ...
        {content.steps && content.steps.length > 0 && (
          <div>
            <h4 className="text-xs font-semibold text-gray-900 mb-2">How to use:</h4>
        ...
        {content.relatedTopics && content.relatedTopics.length > 0 && (
          <div>
            <h4 className="text-xs font-semibold text-gray-900 mb-2">Related topics:</h4>
