          ...
          <div className="space-y-4">
            <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
              ...
              <ul className="text-sm text-gray-600 dark:text-gray-400 list-disc list-inside space-y-1">
                <li><span className="text-blue-500">Blue</span> - Starting budget</li>
                <li><span className="text-orange-500">Orange</span> - Commitments (decreases available budget)</li>
                <li><span className="text-red-500">Red</span> - Actuals (decreases available budget)</li>
                <li><span className="text-green-500">Green</span>/<span className="text-red-500">Red</span> - Final variance (under/over budget)</li>
              </ul>
            </div>
                ...
                <div className="flex items-center gap-1">
                  {shortcut.keys.map((key, j) => (
                    <React.Fragment key={j}>
                      {j > 0 && <span className="text-gray-400 text-xs">or</span>}
