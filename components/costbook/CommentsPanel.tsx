        ...
        <div className="flex items-center gap-3 mt-3 pt-2 border-t border-gray-200">
          ...
          <button
            ...
            className={`flex items-center gap-1 text-xs transition-colors ${
              reactionCounts.like > 0 ? 'text-blue-600' : 'text-gray-400 hover:text-blue-600'
            }`}
          >
          ...
          <button
            ...
            className={`flex items-center gap-1 text-xs transition-colors ${
              reactionCounts.helpful > 0 ? 'text-green-600' : 'text-gray-400 hover:text-green-600'
            }`}
          >
          ...
          <button
            ...
            className={`flex items-center gap-1 text-xs transition-colors ${
              reactionCounts.important > 0 ? 'text-orange-600' : 'text-gray-400 hover:text-orange-600'
            }`}
          >
