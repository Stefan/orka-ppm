...
export default function ScenarioComparison({ scenarios }: ScenarioComparisonProps) {
  ...
  return (
    <div className="space-y-3">
      <h4 className="text-sm font-medium text-gray-700 dark:text-slate-300">Cost Scenarios</h4>
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {scenarios.map((s) => (
          ...
          >
            <p className="text-xs font-medium text-gray-500 dark:text-slate-400 uppercase tracking-wide capitalize">
