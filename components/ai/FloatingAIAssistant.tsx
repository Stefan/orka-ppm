...
export const FloatingAIAssistant: React.FC<FloatingAIAssistantProps> = ({
  ...
  const getInsightColors = (type: AIInsight['type']) => {
    switch (type) {
      case 'tip':
        return 'bg-blue-50 border-blue-200 dark:border-blue-800 text-blue-800 dark:text-blue-300'
      case 'warning':
        return 'bg-amber-50 border-amber-200 text-amber-800'
      case 'suggestion':
        return 'bg-green-50 border-green-200 dark:border-green-800 text-green-800 dark:text-green-300'
      case 'help':
      default:
  ...
  return (
    ...
    >
      ...
      <div className="bg-white dark:bg-slate-800 rounded-lg shadow-xl border border-gray-200 dark:border-slate-700 overflow-hidden">
        {/* Header */}
        <div className="flex items-center justify-between p-4 bg-gradient-to-r from-blue-50 to-indigo-50 border-b border-gray-200 dark:border-slate-700">
          <div className="flex items-center space-x-2">
            <div className="p-1.5 bg-blue-100 dark:bg-blue-900/30 rounded-full">
              <MessageCircle className="h-4 w-4 text-blue-600 dark:text-blue-400" />
            </div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-slate-100">AI Assistant</h3>
          </div>
              ...
              return (
                <div
                  ...
                  className={cn(
                    "p-4 border-l-4",
                    colors,
                    index < currentInsights.length - 1 && "border-b border-gray-100 dark:border-slate-700"
                  )}
                >
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        {insight.dismissible && (
                          <button
                            ...
                            className="text-xs text-gray-500 hover:text-gray-700 dark:hover:text-slate-300 dark:text-slate-300 transition-colors"
                          >
                            Dismiss
                          </button>
                        )}
