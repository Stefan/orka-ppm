...
export const ConfidenceBadge: React.FC<{ confidence: number; className?: string }> = ({ 
  ...
  const getConfidenceColor = (score: number) => {
    if (score >= 0.8) return 'bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300 border-green-300'
    if (score >= 0.6) return 'bg-yellow-100 dark:bg-yellow-900/30 text-yellow-800 dark:text-yellow-300 border-yellow-300'
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h3 className="text-lg font-semibold text-gray-900 dark:text-slate-100">Resource Optimization Results</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-white dark:bg-slate-800 p-4 rounded-lg border border-gray-200 dark:border-slate-700">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm font-medium text-gray-700 dark:text-slate-300">Total Cost Savings</span>
        ...
        <div className="bg-white dark:bg-slate-800 p-4 rounded-lg border border-gray-200 dark:border-slate-700">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm font-medium text-gray-700 dark:text-slate-300">Recommendations</span>
      ...
      <div className="bg-white dark:bg-slate-800 p-4 rounded-lg border border-gray-200 dark:border-slate-700">
        <h4 className="text-sm font-medium text-gray-700 dark:text-slate-300 mb-4">Resource Allocation (Hours)</h4>
      ...
      <div className="bg-white dark:bg-slate-800 p-4 rounded-lg border border-gray-200 dark:border-slate-700">
        <h4 className="text-sm font-medium text-gray-700 dark:text-slate-300 mb-4">Cost Savings by Resource</h4>
        <ResponsiveContainer width="100%" height={300}>
          <PieChart>
            <Pie
              data={chartData}
      ...
      <div className="bg-white dark:bg-slate-800 p-4 rounded-lg border border-gray-200 dark:border-slate-700">
        <h4 className="text-sm font-medium text-gray-700 dark:text-slate-300 mb-3">Detailed Recommendations</h4>
        <div className="space-y-2">
          {recommendations.map((rec, index) => (
            <div key={index} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-slate-800/50 rounded-lg">
              <div className="flex-1">
                <div className="font-medium text-gray-900 dark:text-slate-100">{rec.resource_name}</div>
...
export const RiskForecastChart: React.FC<{
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h3 className="text-lg font-semibold text-gray-900 dark:text-slate-100">Risk Forecast</h3>
        <ConfidenceBadge confidence={modelConfidence} />
      </div>

      <div className="bg-white dark:bg-slate-800 p-4 rounded-lg border border-gray-200 dark:border-slate-700">
        <h4 className="text-sm font-medium text-gray-700 dark:text-slate-300 mb-4">Risk Probability Over Time</h4>
        <ResponsiveContainer width="100%" height={300}>
      ...
      <div className="bg-white dark:bg-slate-800 p-4 rounded-lg border border-gray-200 dark:border-slate-700">
        <h4 className="text-sm font-medium text-gray-700 dark:text-slate-300 mb-4">Risk Impact Forecast</h4>
        <ResponsiveContainer width="100%" height={300}>
          <BarChart data={chartData}>
            <CartesianGrid strokeDasharray="3 3" />
            <XAxis dataKey="period" />
      ...
      <div className="bg-white dark:bg-slate-800 p-4 rounded-lg border border-gray-200 dark:border-slate-700">
        <h4 className="text-sm font-medium text-gray-700 dark:text-slate-300 mb-3">Forecast Details</h4>
        <div className="space-y-2">
          {forecasts.map((forecast, index) => (
            <div key={index} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-slate-800/50 rounded-lg">
              <div className="flex-1">
                <div className="font-medium text-gray-900 dark:text-slate-100">{forecast.period}</div>
                <div className="text-sm text-gray-600 dark:text-slate-400">
...
export const ValidationIssuesDisplay: React.FC<{
  ...
  const getSeverityIcon = (severity: string) => {
    switch (severity) {
      ...
      default:
        return <Info className="w-5 h-5 text-gray-600 dark:text-slate-400" />
    }
  }
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h3 className="text-lg font-semibold text-gray-900 dark:text-slate-100">Data Validation Results</h3>
        <span className="text-sm text-gray-600 dark:text-slate-400">{totalIssues} issues found</span>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg border border-blue-200 dark:border-blue-800">
          ...
          <div className="text-2xl font-bold text-blue-600 dark:text-blue-400">{lowCount}</div>
        </div>
      </div>

      {summaryData.length > 0 && (
        <div className="bg-white dark:bg-slate-800 p-4 rounded-lg border border-gray-200 dark:border-slate-700">
          <h4 className="text-sm font-medium text-gray-700 dark:text-slate-300 mb-4">Issues by Severity</h4>
      ...
      <div className="bg-white dark:bg-slate-800 p-4 rounded-lg border border-gray-200 dark:border-slate-700">
        <h4 className="text-sm font-medium text-gray-700 dark:text-slate-300 mb-3">Issue Details</h4>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center space-x-2 mb-1">
                    <span className="text-xs font-semibold text-gray-900 dark:text-slate-100">{issue.severity}</span>
                    <span className="text-xs text-gray-600 dark:text-slate-400">•</span>
                    <span className="text-xs text-gray-600 dark:text-slate-400">{issue.category}</span>
                    <span className="text-xs text-gray-600 dark:text-slate-400">•</span>
                    <span className="text-xs text-gray-600 dark:text-slate-400">{issue.entity_type}</span>
                  </div>
                  <p className="text-sm text-gray-900 dark:text-slate-100 mb-1">{issue.description}</p>
