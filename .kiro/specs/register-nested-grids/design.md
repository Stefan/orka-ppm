...
*Für die* Costbook View, sollen alle konfigurierten Nested Grid Features (Inline-Editing, Filters, Drag&Drop, Multi-Level Nesting) vollständig unterstützt werden.
...
- **E2E Testing:** Playwright (für Costbook Integration)
