/**
 * API Route Tests: V1 Financials Actuals
 * GET /api/v1/financials/actuals (paginated list, Supabase)
...
describe('GET /api/v1/financials/actuals', () => {
  ...
  it('returns 503 when Supabase is not configured', async () => {
    ...
    const { GET } = await import('@/app/api/v1/financials/actuals/route')
    const request = createMockNextRequest({
      url: 'http://localhost:3000/api/v1/financials/actuals',
      method: 'GET',
    })
  ...
  it('returns 200 with data and pagination when Supabase returns rows', async () => {
